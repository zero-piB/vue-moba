<template>
    ...
    <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
        <el-menu router :default-openeds="opens" unique-opened :default-active="$route.path">
          <el-submenu index="1">
              <template slot="title"><i class="el-icon-message"></i>内容管理</template>

              <el-menu-item-group>
                  <template slot="title">物品</template>
                  <el-menu-item index="/items/create">物品管理</el-menu-item>
          ...
          <el-submenu index="2">
            <template slot="title"><i class="el-icon-s-cooperation"></i>运营管理</template>
            <el-menu-item-group>
